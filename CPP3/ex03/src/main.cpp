...
/*   Updated: 2025/04/14 10:56:12 by phkevin          ###   Luxembourg.lu     */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	std::cout << std::endl;
	std::cout << YELLOW << "------------------------------------" << RESET << std::endl;
	std::cout << YELLOW << "DIAMONDTRAP EX03" << RESET << std::endl;
	std::cout << YELLOW << "------------------------------------" << RESET << std::endl;
	std::cout << std::endl;
	std::cout << std::endl;
	...
	std::cout << "I am " << diam.getDiamName() << std::endl
		<< "HitPoints: " << diam.FragTrap::getHitPoints() << std::endl
		<< "EnergyPoints: " << diam.ScavTrap::getEnergyPoints() << std::endl
		<< "AttackDamage: " << diam.FragTrap::getAtkDamagePoints() << std::endl;
	diam.attack("FANTOM");
	diam.takeDamage(5);
	std::cout << "I am " << diam.getDiamName() << std::endl
		<< "HitPoints: " << diam.FragTrap::getHitPoints() << std::endl
